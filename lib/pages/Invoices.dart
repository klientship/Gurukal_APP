...
Future<InvoiceModel> getInvoices(user_id) async {
  // final String apiUrl = "https://crm.gurukal.in/api/customers/${user_id}/invoices";
...
bool checkPayment(totalPaid, total) {
  double totalCharge = double.parse(total);
  if (totalPaid != totalCharge.toInt()) {
    //unpaid
    return true;
  } else {
    return false;
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return ListTile(
                            ...
                            title: Text(snapshot.data.data.shipment[index]
                            ...
                            subtitle: snapshot.data.data.shipment[index]
                                ...
                                : Text("NO INFO"),
                            trailing: checkPayment(
                                    snapshot
                                        .data.data.shipment[index].totalPaid,
                                    snapshot
                                        .data.data.shipment[index].chargeTotal)
                                ? Chip(
